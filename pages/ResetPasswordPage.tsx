        ...
        <div className="min-h-screen bg-slate-50 font-['Outfit'] flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-5xl overflow-hidden flex flex-col md:flex-row min-h-[600px]">
                ...
                <div className="w-full md:w-5/12 bg-slate-50 p-10 flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 w-64 h-64 bg-slate-100/50 rounded-full blur-3xl -ml-16 -mb-16" />

                    <div className="relative z-10 w-full h-full flex flex-col justify-between">
                        <Link to="/login" className="inline-flex items-center gap-2 text-slate-500 hover:text-black transition-colors font-bold mb-8 group">
                        ...
                        <div className="flex-1 flex flex-col justify-center space-y-6">
                            <div className="inline-flex items-center gap-2 bg-slate-50 border border-slate-100 px-3 py-1 rounded-full w-fit">
                                ...
                                <span className="text-slate-700 font-bold text-xs uppercase tracking-wider">Secure Reset</span>
                            </div>
                            <h1 className="text-4xl font-extrabold text-slate-900 leading-[1.1]">
                                Set your <br /><span className="text-black">new password.</span>
                            </h1>
                                    ...
                                    <>
                                        <div className="space-y-1.5">
                                            ...
                                            <div className="relative">
                                                <input
                                                    ...
                                                    className="w-full px-5 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-black/10 focus:border-black transition-all font-medium text-slate-900 pr-12"
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <input
                                                ...
                                                className="w-full px-5 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-black/10 focus:border-black transition-all font-medium text-slate-900"
                                        ...
                                        <button
                                            ...
                                            className="w-full py-3.5 bg-slate-900 text-white rounded-xl font-bold text-lg hover:bg-black transition-colors shadow-lg hover:shadow-xl hover:-translate-y-0.5 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed disabled:translate-y-0"
                                        >
