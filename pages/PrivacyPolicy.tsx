        ...
        <div className="min-h-screen font-['Outfit'] bg-white">
            <div className="max-w-4xl mx-auto px-6 py-24">
                ...
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <span className="text-sm font-bold text-black tracking-wider uppercase">Privacy & Safety</span>
                </div>
                ...
                <div className="prose prose-lg prose-slate max-w-none">
                    <p>
                        At XGo, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclosure, and safeguard your information when you visit our website and use our application.
                    </p>
                    ...
                    <ul className="list-disc pl-6 space-y-2 mb-6 text-slate-600">
                        ...
                        <li><strong>X Integration Data:</strong> We access public X data and perform actions on your behalf (posting, commenting) only as authorized by you via the X API. We do not store your X password.</li>
                    </ul>
                    ...
                    <ul className="list-disc pl-6 space-y-2 mb-6 text-slate-600">
                        ...
                        <li>Generate personalized AI responses for your X engagement.</li>
                        <li>Monitor and analyze usage and trends to improve your experience.</li>
                        <li>Notify you of updates to the Application.</li>
                        <li>Offer recommendations and improvements to your X outreach strategy.</li>
                    </ul>
                    ...
                    <ul className="list-disc pl-6 mt-4 space-y-2 mb-6 text-slate-600">
                        ...
                        <li><strong>Permanent Removal:</strong> After the 14-day grace period, all personal data, brand profiles, and X integration tokens are <strong>permanently purged</strong> from our active databases.</li>
